This is a project where I have built a hashtable(dictionary) from scratch in order to better understand how dictionaries work. I used Test driven development in every step of the code.
